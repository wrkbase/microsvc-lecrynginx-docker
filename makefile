...
# Copy Temporary SSL Certificates, since LetsEncrypt.org too many certificates already issued for this exact set of domains in last 24 hours
start-leissue-docker:
	mkdir -p letsencrypt/live/${DOMAIN}
	cp -rf ssl/* letsencrypt/live/${DOMAIN}/
	echo "Starting all 3 Micro-Services..."
